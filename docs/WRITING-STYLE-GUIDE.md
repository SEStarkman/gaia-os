...
- **Quality over quantity.** One great post beats five mediocre posts.
...
```
I built my software startup in 6 months completely by myself.
The only moat any company will have in 2026 is distribution.
Most productivity advice is designed to make you feel busy, not get results.
```
...
- Boldface overuse
- Emoji overuse
- "**Term:** definition" list format for everything
...
- [ ] Has engagement trigger (question, hot take, etc.)
- [ ] Scannable format
